...
`Tabs.Panels` 안에서는 기존 내용의 퇴장 200ms → 간격 100ms → 새 내용의 등장 300ms 순서로 재생합니다. `--rbx-motion-delay-tabs`는 기존 100ms 토큰을 사용하며, `--rbx-motion-distance-tabs`는 24px입니다. 선택한 탭의 방향에 따라 퇴장과 등장 방향이 반대가 됩니다. 움직임 감소 설정에서는 전환과 간격을 생략합니다.
